...
def full_cv():
  full_cv = jsonify(
      {
        "about": 'A diplomat turned traveler turned developer. Experienced in development and managing teams. Having lived in 4 countries I have strong intercultural communication skills. Currently self-learning (40hrs/week - see my progress here: https://twitter.com/jsphWllng). I love learning new tech, automating my work, overusing the word groovy and eating barbecue.'
        },
      {"contact_details": ["jsphwllng@gmail.com", "https://github.com/jsphwllng", "https://twitter.com/jsphWllng"]},
      {"languages": ["python", "ruby", "some golang", "MERN", "rails", "flask"]},
      {"experiences": [{
      ...
      {"hobbies": ["disco", "eating", "cooking", "plant dad", "blogging", "yoga", "ping pong", "fermentation", "ginger beer connoisseur", "twitter bots", "overly complicated CVs"]}
      )
  if (request.method == 'GET'):
    return full_cv
...
def post():
  ...
  parser.add_argument('name', type=str, help='the person leaving this comment')
  parser.add_argument('comment', type=str,
                      help='what do you want to comment?')
